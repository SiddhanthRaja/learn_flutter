...
class Cards extends StatelessWidget  {
  ...
  int isCorrect(List<String> playerCards){
    ...
    final PokerHand chosenBestHand = PokerHandDetector.bestHandNoLimits(tableCards, playerCards);
    final PokerHand otherBestHand = PokerHandDetector.bestHandNoLimits(tableCards, listOp[0]!=playerCards ? listOp[0] : listOp[1] );
